// Nox Vault v1.3.1 extension download update 2026-09-15
...
function renderSettings(){
  ...
  <div class="settings-grid">
    ...
    <section class="card setting-group"><h3>Chrome Companion</h3>
      ...
      <div class="status-list"><div class="status-line"><span>Viewing</span><b>Original website</b></div><div class="status-line"><span>Metadata</span><b>Live page content script</b></div><div class="status-line"><span>Related videos</span><b>Best-effort DOM scan</b></div><div class="status-line"><span>Package</span><b>Companion v1.3</b></div></div>
      <div class="form-actions" style="justify-content:flex-start;margin-top:12px"><a class="btn primary" href="./downloads/nox-vault-companion-extension-legacy-v1.3.2.zip" download>⇩ Download Legacy Chrome Companion (.zip)</a><button class="btn ghost" data-extension-settings>Extension Settings</button></div>
