...
function renderSettings(){
  ...
  <div class="settings-grid">
    ...
    <section class="card setting-group"><h3>Chrome Companion</h3>
      ...
      <div class="form-actions" style="justify-content:flex-start;margin-top:12px"><a class="btn primary" href="./downloads/nox-vault-companion-extension-v1.3.zip" download>⇩ Download Chrome Companion (.zip)</a><button class="btn ghost" data-extension-settings>Extension Settings</button></div>
